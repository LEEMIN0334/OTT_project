...
<body>
    ...
    <main>
        ...
        <div>
        <input type="radio" id="groupheve" name="groupheve" value="true">
        <label for="groupheve">내 그룹에서 찾기</label>
        ...
        <input type="radio" id="groupheve" name="groupheve" value="false">
        <label for="groupheve">현재 그룹이 없으신가요?</label>
